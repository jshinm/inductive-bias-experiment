...
class IB:
    def __init__(self):
        ...
        self.spiral = DG.spiral_center(N=120,rng=1)

    def get_trueSpiral(self, l, r, h, sig=0.00008, rng=1, cc=True):
        '''
        get true posterior for spiral dataset
        '''
        return DG.true_spiral(l=l,r=r,h=h,sig=sig,rng=rng,cc=cc)
